                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Tambah Admin
                        </h1><?php echo form_open_multipart('user/createAdmin'); ?>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="<?php echo site_url('user') ?>">Daftar Admin</a>
                            </li>
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <?php foreach ($data_login as $key) {?>                 
                               ...
                               <img style="margin-top: 1px" src="<?=base_url()?>assets/uploads/admin.png" width="150px" height="165px" >
                    ...
                    <div class="col-lg-6" style="margin-top: -70px">
                            ...
                            <div style="margin-top: 0px" class="form-group">
                                <label>Status</label>
                                <input style="text-transform: capitalize;" class="form-control" id="disabledInput" type="text"  placeholder="Admin" disabled>
                            
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-success"><i class="glyphicon glyphicon-adjust"></i>  Tambah Admin</button>
