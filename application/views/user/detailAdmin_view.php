    ...
    <div id="page-wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><?php foreach ($admin_detail as $key) {
                        ?>
                           <span class="label label-primary"> Detail Admin</span> <b><span class="glyphicon glyphicon-king"></span> <span class="label label-primary"><?php echo $key->nama; ?></span></b>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <i class="fa fa-fw fa-user"></i> <a href="<?php echo site_url('user') ?>">Admin</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> Detail Admin
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="table-responsive">
                            <div class="panel panel-primary">
                                <div class="panel-heading" style="text-align: center">Data Lengkap Admin</div>
                                <table class="table" style="text-indent: 10px;">
                                    <tbody><?php foreach ($admin_detail as $key) { ?>
                                        <tr>
                                            <td>ID Admin</td>
