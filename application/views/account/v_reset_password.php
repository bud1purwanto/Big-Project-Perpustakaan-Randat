        ...
        <div id="loginbox" style="margin-top:-370px; margin-left: 500px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-success" >
                            <div class="panel-heading">
                                <div style="text-indent: 90px  " class="panel-title" style="margin-left: 20px; margin-top: 10px"><i class="glyphicon glyphicon-lock"></i> Reset Password</div></div>
                                <div style="text-indent: 80px" class="alert alert-info">Hello <span><?php echo $nama; ?></span>, Silakan isi password baru anda.</div>
                               ...
                               <?php if (validation_errors()) {
                                   ?><div style="margin-top: -30px" class="alert alert-danger">
                                    ...
                                    <div style="margin-bottom: 25px;margin-top: -0px" class="input-group">
                                                ...
                                                <input id="password" type="password" class="form-control" name="password" value="<?php echo set_value('password') ?>" placeholder="Masukkan Password">
                                            </div>

                                      <div style="margin-bottom: 25px;margin-top: -0px" class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                                <input id="passconf" type="password" class="form-control" name="passconf" value="<?php echo set_value('passconf') ?>" placeholder="Masukkan Konfirmasi Password">
                                            </div>
                                        ...
                                        <div style="margin-top:10px" class="form-group">
                                            ...
                                            <div class="col-sm-12 controls">
                                             <button style="width: 200px; margin-left: 130px" type="submit" class="btn btn-success">Reset Password</button>
                                            </div>
                                            <?php echo form_close(); ?>
                                        </div> 
                            </div>          
